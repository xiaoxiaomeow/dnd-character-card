...
- HP40（6HD）：生命骰8+体调1+(生命骰5+体调1)x5
- AC18：基础10+四镜甲6+敏调2
- 措手不及AC16：基础10+四镜甲6
- 接触AC12：基础10+敏调2
- CMD25：基础10+BAB6+力调7+敏调2
- 强韧+10：基础5+体调1+守护之符2(抗力)+幸运头带1(运气)+天佑者1
- 反射+6：基础2+不协调-2+敏调2+守护之符2(抗力)+幸运头带1(运气)+天佑者1
- 意志+11/+13：基础5+感调2+守护之符2(抗力)+幸运头带1(运气)+天佑者1+[对抗惑控:精灵免疫2(种族)]
...
- BAB：6=基础4+武装技法2
- CMB+13：BAB6+力调7
- 摔绊、卸武、破武CMB+14：BAB6+力调7+增强1
- 近战攻击命中+12：BAB6+力调7+增强1+猛力攻击-2
- 近战攻击伤害+17：1.5*力调7+增强1+猛力攻击6
- - 反曲剑，+10命中，1d8+16挥砍，19-20/x3
- 触手攻击命中+8：BAB6+力调7+次要天武-5
- 这是拥有10尺触及的次要天武攻击。这些藤蔓无法造成伤害，但是移植真菌的生物可以尝试将一个被击中的目标向自己的方向拉近5英尺，视为拉拽（Pull）通用怪物能力（探索者怪物图鉴303）。

## 属性

- 力量24（+7）：骰点17+种族2+肉体附魔4(增强)+属性成长1
- 敏捷15（+2）：骰点13+敏捷腰带2(增强)
- 体质13（+1）：骰点13
- 智力14（+2）：骰点14
- 感知14（+2）：骰点14
- 魅力11（+0）：骰点11
...
- 游泳+11：力调7+技能点1+本职技能3+也许有盔甲检定减值
- 法术辨识+13：智调2+技能点6+本职技能3+精制品工具2(环境)
...
灵器点12个=秘学等级6+感调2+精灵fcb3+灵装专家1，分配给变化灵器6个，防护灵器6个
...
<details>
<summary>
3级：战斗耐力 (Combat Stamina) <sup>Uch</sup>〔战斗〕，耐力池7=bab6+体调1
</summary>
...
<details>
<summary>
心智点（Mental Focus，Su），12/日=秘学等级6+感调2+精灵fcb3+灵装专家1
</summary>
...
<details>
<summary>
防护学派基本灵器之力，念力护壁（Mind Barrier，Sp），吸收伤害12=2*秘学士等级6
</summary>
...
1~6级，精灵：心智点（Mental Focus）的总点数增加1/2点。
