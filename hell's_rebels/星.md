...
- 飞行+5：敏调1+技能点1+本职技能3
- 法术辨识+17/+19：智调6+技能点7+本职技能3+破损的深红混蓝艾恩石1(表现)+[化泪为酒2(增强)]
- 知识（奥秘）+19/+23：智调6+技能点7+本职技能3+技能专攻3+[化泪为酒2(增强)]+[强化认知2(表现)]
- 知识（宗教）+16/+20：智调6+技能点7+本职技能3+[化泪为酒2(增强)]+[强化认知2(表现)]
- 知识（位面）+15/+19：智调6+技能点6+本职技能3+[化泪为酒2(增强)]+[强化认知2(表现)]
...
[光耀爆发](https://xiaoxiaomeow.github.io/pathfinder/spell?spell=burst%20of%20radiance)<sup>PCS-CoP</sup>（DC19）
空置
+[识破隐形](https://xiaoxiaomeow.github.io/pathfinder/spell?spell=see%20invisibility)
- 三环3+1（基础2+属性奖励1+学派1）
[加速术](https://xiaoxiaomeow.github.io/pathfinder/spell?spell=haste)
...
+[解除魔法](https://xiaoxiaomeow.github.io/pathfinder/spell?spell=dispel%20magic)
- 四环2+1（基础1+属性奖励1+学派1）
[困惑术](https://xiaoxiaomeow.github.io/pathfinder/spell?spell=confusion)（DC20）
[冰墙术](https://xiaoxiaomeow.github.io/pathfinder/spell?spell=wall%20of%20ice)
+[游荡星尘](https://xiaoxiaomeow.github.io/pathfinder/spell?spell=wandering%20star%20motes)<sup>APG</sup>（DC20）
...
<details>
<summary>
7级：次级法术融合 (Lesser Spell Synthesis) <sup>PPC-CoL</sup>
</summary>
...
- <details><summary>日光杖 2gp 1磅</summary>这支1尺长度的金头铁杖可以在敲击（通过一个标准动作）后以光亮程度的照明照亮30尺半径的区域，并在额外30尺的范围内使光照等级上升1级（黑暗变成昏暗[Dim Light]，昏暗变成普通光照），但是日光杖无法把光照等级提高到普通光照或明亮光照以上。一支日光杖可以维持发亮6小时，之后黄金就会烧尽，只留下无用的铁条。</details>x10
- 艾恩石
